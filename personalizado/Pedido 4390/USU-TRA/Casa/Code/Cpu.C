...
/* DDRB: DDRB5=0,DDRB4=0 */
  output( DDRB, input( DDRB ) & ~48 );
/* PTCPUE: PTCPUE5=0,PTCPUE4=0 */
  output( PTCPUE, input( PTCPUE ) & ~48 );
/* PTC: PTC5=0,PTC4=0 */
  output( PTC, input( PTC ) & ~48 );
/* DDRC: DDRC5=0,DDRC4=0 */
  output( DDRC, input( DDRC ) & ~48 );
  /* ### MC68HC908GP32_44 "Cpu" init code ... */
  ...
  TIMER_Init();
  /* ### BitsIO "APERTURA" init code ... */
  Shadow_PTC = Shadow_PTC & ~48 | 0;   /* Initialize shadow variable */
